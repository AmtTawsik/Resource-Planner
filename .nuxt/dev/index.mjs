globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/devalue/index.js';
import { renderToString } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/Qualyval/Real-Project/Resource-Planner/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Qualyval\\Real-Project\\Resource-Planner\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _P8npeI3tFG = (function(nitro) {
...
const _lazy_h9CLh1 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_h9CLh1, lazy: true, middleware: false, method: undefined },
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"We assist businesses in achieving growth, solving problems, enhancing productivity, and optimising efficiency through the application of AI, Automation, and Digital technologies."}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/logo-saveefforts-2.png"}],"style":[],"script":[],"noscript":[],"title":"Resource Planner","charset":"utf-8","viewport":"width=device-width, initial-scale=1","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file://E:/Qualyval/Real-Project/Resource-Planner/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/Qualyval/Real-Project/Resource-Planner/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
